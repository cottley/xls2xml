...
public class Xls2xmlSuite {

    protected static Object test;
    protected static int failures = 0;
    
    public static final String MAIN_CLASS = "com.referencelogic.xls2xml.test.Test";

    public static void main(String args[]) {
        new TestSuite(Xls2xmlSuite.class).run(new TestResult());
    }
