// Generated by delombok at Tue Oct 02 15:46:20 BOT 2012
...
public class Landmark {
	...
	@java.lang.SuppressWarnings("all")
	public void setCollectionScope(final String collectionScope) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		final java.lang.Object this$collectionScope = this.getCollectionScope();
		final java.lang.Object other$collectionScope = other.getCollectionScope();
		if (this$collectionScope == null ? other$collectionScope != null : !this$collectionScope.equals(other$collectionScope)) return false;
	...
	public int hashCode() {
		...
		final java.lang.Object $collectionScope = this.getCollectionScope();
		result = result * PRIME + ($collectionScope == null ? 0 : $collectionScope.hashCode());
	...
	public java.lang.String toString() {
		return "Landmark(value=" + this.getValue() + ", id=" + this.getId() + ", direction=" + this.getDirection() + ", distance=" + this.getDistance() + ", collectionType=" + this.getCollectionType() + ", collectionId=" + this.getCollectionId() + ", collectionScope=" + this.getCollectionScope() + ", collectionSection=" + this.getCollectionSection() + ", row=" + this.getRow() + ", col=" + this.getCol() + ", sheetNo=" + this.getSheetNo() + ")";
	}
}